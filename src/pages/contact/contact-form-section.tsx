...
class ContactFormSection extends React.Component <IProps, IState> {
    ...
    onChange = (e: any) => {
        ...
        switch (name) {
            case 'name':
                formErrors.name = value.length < 10 ? "Minimum 10 Characters required as (Ms Club Of Sliit)" : "";
                break;
            case 'email':
                console.log(value)
            ...
            case 'message':
                console.log(value)
                formErrors.message = value.length < 10 ? "Write a message to us / Minimum 10 Characters required" : "";
                break;
            default:
                break;
        }
                                ...
                                <form id="myForm" onSubmit={e => this.handleSubmit(e)}>
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        <input
                                            ...
                                            name="name"
                                            type="text"
                                            className={formErrors.name.length > 0 ? "form-control border-danger" : 'form-control'}
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        <input
                                            ...
                                            name="email"
                                            type="text"
                                            className={formErrors.email.length > 0 ? "form-control border-danger" : 'form-control'}
                                            onChange={this.onChange}
                                            required
                                        />
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        <textarea
                                            id="message"
                                            name="message"
                                            className={formErrors.message.length > 0 ? "form-control border-danger" : 'form-control'}
                                            rows={6}
                                            onChange={this.onChange}
                                            required
                                        />
